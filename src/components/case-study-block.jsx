...
const CaseStudyBlock = ({ direction, image, url, tag, text, title, site }) => {
  console.log("Case Study Block", url);
  return (
    <div className="relative max-w-lg mx-auto lg:max-w-none lg:mx-none lg:mb-[280px]">
      ...
      <div
        className={`relative bottom-0 ${direction && direction === "left" ? "left-0" : "right-0"} z-20 block w-full h-auto p-6 shadow-xl lg:rounded-3xl rounded-b-3xl sm:p-8 lg:p-12 bg-dark-700 lg:absolute lg:-bottom-25 lg:w-[450px] lg:h-full`}>
        <div className="h-full lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="mt-8 xl:mt-4 flex gap-3">
            <ButtonSolidRound
