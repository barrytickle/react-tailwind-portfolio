...
function ButtonAnimated(props) {
  return (
    <Link
      onClick={linkClicked}
      className={`relative flex items-center justify-center w-auto px-8 ml-0 text-base font-medium leading-snug text-white h-14 sm:ml-4 sm:mt-0 group ${props.className ?? ""}`}
      to={props.url}>
